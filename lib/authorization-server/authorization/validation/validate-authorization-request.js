...
async function validateAuthorizationRequest({ client_id: clientId, redirect_uri: redirectUri, scope }, options) {
  ...
  validateScopeToken(currentClient.accessAbility, scopeToken);

  validateRedirectUri(currentClient.redirectUri, redirectUri);
}

module.exports = validateAuthorizationRequest;

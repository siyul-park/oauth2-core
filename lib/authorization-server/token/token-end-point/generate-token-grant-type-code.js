const validateGenerateTokenGrantTypeCode = require('../validation/grant-type-code/validate-generate-token');
...
async function generateToken(request, options) {
  ...
  const { client_id: clientId, code } = request;
  ...
  }, { scope: createAccessTokenScope, requestScope: decodedCode.requested_scope });
